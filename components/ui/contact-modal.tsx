            ...
            <form
              ...
              onSubmit={(e) => {
                ...
                const subject = encodeURIComponent(
                  "Inspecheck demo/contact request"
                );
                ...
                window.location.href = `mailto:info@inspecheck.com?subject=${subject}&body=${body}`;
              }}
            >
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-md bg-[#a78bfa] text-white hover:bg-[#8b5cf6]"
                >
                  Send email
                </button>
              </div>
              <p className="text-xs text-gray-500 pt-2">
                This opens your email client to contact info@inspecheck.com
              </p>
            </form>
          </div>
        </div>
